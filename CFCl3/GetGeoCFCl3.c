...
int main() {
  ...
  a1 = 0;
  // Methods
  char v[35][10] = {"PBE",      "BLYP",      "BP86",    "B3LYP",   "OLYP",
                    "PW91",     "mPW91",     "revPBE",  "TPSS",    "M06-L",
                    "M11-L",    "PBE0", "mPW1K",   "BHandHLYP",
                    "BHandH",   "SOGGA11-X", "M06",     "M06-2X",  "M06-HF",
                    "BB1K",     "B1B95",     "mPWB1K",  "mPW1B95", "PW6B95",
                    "M11",      "CAM-B3LYP", "LC-BLYP", "LC-PBE",  "LC-wPBE",
                    "LRC-wPBEh"};
  ...
  for (int i2 = 0; i2 < 32; i2++) {
    ...
    arq = fopen(caminho, "r");
    arqf = fopen("/home/florincy/Documentos/nwchem/CFCl3/XYZCFCl3.txt", "a");
    if (!arq) {
