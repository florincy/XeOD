...
int main() {
  ...
  char busca[6][50] = {"Atom    1: 129-Xe and Atom    2:  19-F",
                       "Atom    1: 129-Xe and Atom    3:  19-F",
                       "Atom    1: 129-Xe and Atom    4:  19-F",
                       "Atom    1: 129-Xe and Atom    5:  19-F",
                       "Atom    1: 129-Xe and Atom    6:  19-F",
                       "Atom    1: 129-Xe and Atom    7:  19-F"};

  for (int i2 = 0; i2 < 32; i2++) {
    // Path by parts
    char caminho[100] = "/home/florincy/Documentos/nwchem/NMR/XeF6/";
    ...
    arqf = fopen(
        "/home/florincy/Documentos/nwchem/NMR/XeF6/CouplingConstantXeF6.txt",
        "a");
    if (!arqf) {
